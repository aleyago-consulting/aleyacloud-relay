...
export function App() {
  ...
  return <Panel context={context} logout={async () => { await api("/panel/logout/", { method: "POST" }); setContext(null); }} />;
}
